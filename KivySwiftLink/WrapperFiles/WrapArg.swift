...
struct WrapArg: Codable, Equatable {
    let name: String
    let type: PythonType
    ...
    let objc_name: String
    let objc_type: String
...
extension WrapArg {
    ...
    init(name: String, type: PythonType, other_type: String, idx: Int, is_return: Bool, is_list: Bool, is_json: Bool, is_data: Bool, is_tuple: Bool) {
        self.name = name
        self.type = type
